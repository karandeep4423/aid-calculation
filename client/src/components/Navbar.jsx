    ...
    <div className=" ">
      <nav className=" flex justify-between h-20 px-4 xl:px-0 max-w-screen-xl m-auto     ">
        ...
        >
          ...
          <Link onClick={handleShow} to="/simulation">Simulation</Link>
          <Link onClick={handleShow} to="/about-us">About us</Link>
          <Link onClick={handleShow} to="/contact-us">Contact us</Link>
