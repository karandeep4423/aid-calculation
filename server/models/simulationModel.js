...
const simulationSchema = new mongoose.Schema({
    ...
    typeSimulation: {
        type: String,
        enum: ['renovation', 'copropriete', 'parc acc', 'loc avantage', 'rempl chauff', 'prime adapt', 'prime ptz'],
        required: false,
    },
    typeBenef: {
        type: String,
        enum: ['Propriétaire occupant', 'Propriétaire bailleur', 'Syndicat de copropiétaires'],
        required: true,
    },
    typeLogement: {
        type: String,
        ...
        validate: {
            ...
            message: 'Type Logement is required when typeBenef is not "Syndicat de copropiétaires"'
        },
        required: function() {
